  ...
  var masonry = new Macy({
    ...
    if (lGgall.length) {
       ...
       //nothing happen
        ...
        // revolution slider
        var revapi;
revapi = jQuery('#revolution-slider-half').revolution({
    delay: 3000,  // Time between slides (9 seconds)
    startwidth: 960,
    startheight: 630,
    onHoverStop: "on",  // Pause on hover
    thumbWidth: 100,
    thumbHeight: 50,
    disableProgressBar: "off",
    thumbAmount: 3,
    touchenabled: "on",
    stopAtSlide: -1,   // Auto-slide, no manual stop
    stopAfterLoops: -1,  // Infinite loop
    navigationType: "none",
    ...
    dottedOverlay: "",
    fullWidth: "on",
    fullScreen: "on",  // Fullscreen slider
    shadow: 0,
    disableProgressBar: "on" 
});

// Full-Screen Configuration for continuous sliding
...
// For commerce slider with continuous sliding
var revext = jQuery;
